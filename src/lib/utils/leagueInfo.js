...
export const homepageText = `
  <p>Welcome to the official UPA Fantasy Football website. We're a group of friends who met online through Pokemon and have since continued to bond through sports. Some of us have known each other since as early as 2015, and our dynasty league was founded in 2020.</p>
     <ul>
     <li>My name is <a style="color:#00C0C0;">Ben</a>. I run the site and also make <a href="https://youtube.com/playlist?list=PLshnoGu2e9MV5_3pnAszrttY25D4BVNXf">annual highlight videos.</a></li>
     <li><a style="color:#00C0C0;">Drew</a> is the commissioner and is in charge of setting up the league meeting every January.</li>
     <li>"The Committee" consists of the two of us as well as <a style="color:#00C0C0;">Derek</a> and <a style="color:#00C0C0;">Survive</a>.</li>
     <ul>
           <li>On the very rare occassions when a controversial issue arises (i.e. alleged collusion), the 4 of us discuss and vote on a course of action. In the event of a 2-2 tie, <a style="color:#00C0C0;">Dork</a> will have the tiebreaking vote.</li>
     </ul>
     <li>and <a style="color:#00C0C0;">Scrappy</a> is in charge of kicking our asses every year.</li>
     </ul>
